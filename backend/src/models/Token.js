...
const Token = new Schema(
  {
    ...
    decimals: { type: Decimal, required: true, default: 18 },
    uri: { type: String, unique: true, required: false, maxLength: 255 },
    address: { type: String, required: true, minLength: 42, maxLength: 42 },
    owner: { type: String, required: true, minLength: 42, maxLength: 42 },
    total_supply: { type: String, required: true, default: 0 },
