...
export default function TransactionAdmin() {
    ...
    return (
        <div className="select-none flex flex-col justify-center items-center w-full px-[4vw] py-[2vw] space-y-[2vw]">
            <Card className="flex flex-col w-full rounded-2xl border-[1px] shadow-md max-h-[86vh] overflow-y-auto">
