            ...
            {!isFetching && transactions?.length && <>
                ...
                <div className="flex flex-col max-h-[55vw] overflow-x-auto ">
                    {transactions.map((item, index) => {
                        ...
                        return (
                            <div key={index} className={`flex flex-row cursor-pointer hover:bg-secondary/80 dark:hover:bg-white/5 text-md font-medium items-center h-[3.5vw] w-full px-4 border-t-[0.2px] border-gray-300 border-opacity-20 ${index === transactions.length - 1 ? 'rounded-b-2xl' : ''}`} >
