...
export default function PoolBox({ tokens, tokenBalances, reservePools }: Props) {
    ...
    }, [provider, signer, address, currentPool, tokenOne, amount1, amount2])
    return (
        <div className="flex flex-col w-full h-full">
            <div className="relative flex flex-col w-full h-full">
                <TradeItem title="Amount" token={tokenOne} tokens={newTokens} setToken={setTokenOne} amount={amount1} setAmount={setAmount1} balance={balance1} />
                <TradeItem title="Amount" token={tokenTwo} tokens={newTokens} setToken={setTokenTwo} amount={amount2} setAmount={setAmount2} balance={balance2} isDisabled />
