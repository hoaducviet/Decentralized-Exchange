    ...
    return (
        <div className="flex flex-col w-full h-full">
            <div className="relative flex flex-col w-full h-full">
                <TradeItem title="Amount" tokenBalance={tokenOne} tokenBalances={balances} setToken={setTokenOne} />
                <TradeItem title="Amount" tokenBalance={tokenTwo} tokenBalances={balances} setToken={setTokenTwo} isDisabled />
