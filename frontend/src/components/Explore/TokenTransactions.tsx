        ...
        <div className="flex flex-col w-full">
            <div className="bg-purple-50 flex flex-row w-full space-x-[2%] pl-[5vw] h-[3vw]">
                {listHeaders.map((item) => {
                    return (
                        <div className="flex flex-col justify-center items-start text-md font-medium w-[15%]">
                            {item.name}
                        </div>
                    )
                })}
            ...
            <div className="flex flex-col w-full max-h-[40vw] overflow-x-auto">
                {transactions.map((transaction) => {
                    return (
                        <div className="flex flex-row text-md font-medium space-x-[2%] hover:bg-secondary/80 w-full h-[4vw] pl-[5vw]">
